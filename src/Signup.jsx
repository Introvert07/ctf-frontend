      ...
      <div className="border-4 border-pink-400 p-10 rounded-xl shadow-[0_0_20px_#ff00ff] bg-black text-pink-300 max-w-md w-full">
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSignup}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`px-6 py-3 mt-4 font-bold rounded shadow-[0_0_10px_#ff00ff] transition-all ${
              loading
                ? "bg-pink-300 text-black cursor-not-allowed"
